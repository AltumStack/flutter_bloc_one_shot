...
[![pub package](https://img.shields.io/pub/v/bloc_effect_test.svg)](https://pub.dev/packages/bloc_effect_test)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/MIT)

Test utilities for [`bloc_effect`](https://pub.dev/packages/bloc_effect). Provides a `blocEffectTest` helper that mirrors the `blocTest` API with added effect verification.
...
```dart
import 'package:bloc_effect_test/bloc_effect_test.dart';
