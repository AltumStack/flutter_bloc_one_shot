...
[![pub package](https://img.shields.io/pub/v/flutter_bloc_effect.svg)](https://pub.dev/packages/flutter_bloc_effect)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](https://opensource.org/licenses/MIT)

Flutter widgets for [`bloc_effect`](https://pub.dev/packages/bloc_effect). Provides `SideEffectListener` and `SideEffectConsumer` that mirror the `BlocListener`/`BlocConsumer` API you already know.
...
This package re-exports `bloc_effect`, so you only need a single dependency for both core and widgets.
